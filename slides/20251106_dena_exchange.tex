...
% TITLE PAGE
\title{RESILIENT -- Resilient Energy System Infrastructure Layouts for Industry, E-Fuels and Network Transitions}
\vspace*{-.5cm}
...
{
  \footnotesize
  \textbf{Iegor Riepin, Bobby Xiong, Lukas Franken}\\
  % Department of Digital Transformation in Energy Systems \\
  Technische Universität Berlin \\
  \alert{Collegial exchange with dena} --- 06 November 2025
}
...
\hspace{0.5cm}\includegraphics[trim=0.2cm 0.6cm 0.6cm 0.2cm,height=1.1cm,clip=true]{logos/bmwe_en_logo.png}
}
...
\begin{frame}{System cost variations for different underlying \textbf{weather years}}

	\source{G{\o}tske, Andresen, Neumann, Victoria, 2024; \url{https://www.nature.com/articles/s41467-024-54853-3} }

	\includegraphics[height=0.9\textheight]{graphics/tsc-weatheryears.png}
...
\begin{frame}{Extending PyPSA-Eur: Representing industrial heating by temperature band}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.5\textwidth}
			\includegraphics[width=1\textwidth]{temperature_band_pie}
		\end{column}
	\end{columns}
...
\begin{frame}{Mitigating Ukraine's Looming Electricity Crisis}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{column}{0.55\textwidth}
			...
			\vfill
			\begin{minipage}[t][0.425\textheight][t]{\linewidth}
				\includegraphics[width=0.9\linewidth,keepaspectratio]{gdu_load_shedding.pdf}
			\end{minipage}
		\end{column}
	...
	\source{Photo by Reuters (credit: Denys Shmyhal); graphs from \url{https://ssrn.com/abstract=4930511}}
...
\begin{frame}{Resilience: Network restoration after a blackout}
	...
	\begin{columns}
		...
		\begin{column}{0.3\textwidth}
			\includegraphics[width=1\textwidth]{blackstart_map}
		\end{column}
	\end{columns}
...
\begin{frame}{Simple, robust solution: Peaker capacity with methanol tanks}
	...
	\begin{columns}
		...
		\begin{column}{0.45\textwidth}
			\includegraphics[width=1\textwidth]{industrial_tank}
		\end{column}
	\end{columns}
...
\begin{frame}{Upcoming: Resilience against gas shocks through EU electrification}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\centering
		\includegraphics[width=\linewidth]{gas_price_resilience_schematic}

		% Right third
		\column{0.32\textwidth}
		\centering
		\includegraphics[width=\linewidth,height=0.22\textheight,keepaspectratio]{power_sector.png}
		\vfill
		\includegraphics[width=\linewidth,height=0.22\textheight,keepaspectratio]{heating_sector.png}
		\vfill
		\includegraphics[width=\linewidth,height=0.22\textheight,keepaspectratio]{industry_sector.png}
		\vfill
		\includegraphics[width=\linewidth,height=0.22\textheight,keepaspectratio]{europe.png}
...
\begin{frame}{PyPSA v1.0: Stochastic and risk-averse optimisation}
	...
	\vspace{0.5cm}
	\includegraphics[width=0.65\textwidth]{stochastic_optimisation}
	\source{\url{https://docs.pypsa.org/latest/user-guide/v1-guide/?h=stochastic}}
\end{frame}

\begin{frame}{RESILIENT -- Resilient Energy System Infrastructure Layouts for Industry, E-Fuels and Network Transitions}

	\textbf{Iegor Riepin, Bobby Xiong, Lukas Franken, Tom Brown}\\
	Technische Universität Berlin, Germany \\
	\vspace{0.5cm}
	\alert{Project coordination}: iegor.riepin@tu-berlin.de \\
	\alert{About project}: \url{https://resilient-project.github.io/} \\
	\alert{About PyPSA ecosystem}: \url{https://pypsa.org/} \\
